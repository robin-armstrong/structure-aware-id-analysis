...
destination = "src/experiments/block_kahan_example/test"
readme      = "Testing the Kahan matrix example."

rng       = MersenneTwister(1)      # random souce, set for reproducibility
n         = 100                     # dimension of Kahan blocks
blocks    = 3                       # number of Kahan blocks
alpha     = .9                      # parameterizes the Kahan blocks
krange    = 1:10:300               # range of approximation ranks to test
numtrials = 3 #50                      # trials per approximation rank
...
if(!plot_only)
    ...
    function run_block_kahan_example(destination, readme, rng, n, blocks, alpha, krange, numtrials, plot_only)
        logstr  = readme*"\n\n"
    ...
    run_block_kahan_example(destination, readme, rng, n, blocks, alpha, krange, numtrials, plot_only)
end
